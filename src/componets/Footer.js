        ...
        <div className="max-w-screen-xl px-4 mx-auto">
          ...
          <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
            <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
              ...
              <button
                className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-yellow-400 rounded-lg shadow-md hover:focus:outline-black focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-purple-200"
                type="submit"
              >
                Subscribe
              </button>
          ...
          <div className="text-center text-slate-500 dark:text-gray-200 pt-10 sm:pt-12  font-normal flex items-center justify-center">
            Copyright 2024 ©Vasudev00725 Projects
          </div>
        </div>
      </footer>
    </div>
